  ...
  render() {
    ...
    return (
      <>
        <ul
          id="sub-1"
          className={subNav.menu1 ? 'sub-list active' : 'sub-list'}
        >
        ...
        <ul
          id="sub-2"
          className={subNav.menu2 ? 'sub-list active' : 'sub-list'}
        >
        ...
        <ul
          id="sub-3"
          className={subNav.menu3 ? 'sub-list active' : 'sub-list'}
        >
        ...
        <ul
          id="sub-4"
          className={subNav.menu4 ? 'sub-list active' : 'sub-list'}
        >
